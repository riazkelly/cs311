...
void meshRender(
	    ...
	    if (sha->attrDim != mesh->attrDim)
            ...
            for (i = 0; i < mesh->triNum; i++) {
                ...
                /* Sets each vertex of tri to a, b, c */
                ...
                shadeVertex(sha->unifDim, unif, attrDim, aa, varyDim, a);
                shadeVertex(sha->unifDim, unif, attrDim, bb, varyDim, b);
                shadeVertex(sha->unifDim, unif, attrDim, cc, varyDim, c);
